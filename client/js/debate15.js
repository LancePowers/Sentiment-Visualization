var debate15 = `The five major candidates are about to face off for the first time in a primary race that is a lot more competitive than many people had expected.
...
The Times reporter Michael D. Shear analyzes key moments from the first Democratic presidential debate in Las Vegas on Tuesday. By MICHAEL D. SHEAR, QUYNHANH DO and A.J. CHAVAR on Publish Date October 13, 2015. Photo by Josh Haner/The New York Times. Watch in Times Video »
...
Former Secretary of State Hillary Clinton. Senator Bernie Sanders of Vermont.
...
//
//    COOPER : Just
//let me just be clear.Is there anybody
//else on the stage who is not a capitalist ?
//
//    CLINTON : Well,
//    let me just follow - up on that, Anderson, because when I think about capitalism, I think about all the small businesses that were started because we have the opportunity and the freedom in our country
//for people to do that and to make a good living
//for
...
//
//
//SANDERS: I think everybody is in agreement that we are a great entrepreneurial nation.We have got to encourage that.Of course, we have to support small and medium - sized businesses.But you can have all of the growth that you want and it doesn’ t mean anything
//if all of the new income and wealth is going to the top 1 percent.So what we need to do is support small and medium - sized businesses, the backbone of our economy, but we have to make sure that every family in this country gets a fair shake...
//
...
//
//    CHAFEE : The party left me.There’ s no doubt about that.There was no room
//for a liberal moderate Republican in that party.I even had a primary
//for my reelection in 2006. I won it.But the money poured in to defeat me in Rhode Island as a Republican.That’ s what we were up against.
//
//COOPER: Governor O’ Malley, the concern of voters about you is that you tout our record as Baltimore’ s mayor.As we all know, we all saw it.That city exploded in riots and violence in April.The current top prosecutor in Baltimore, also a Democrat, blames your zero tolerance policies
//for sowing the seeds of unrest.Why should Americans trust you with the country when they see what’ s going on in the city that you ran
//for more than seven years ?
//
//    O’ MALLEY : Yes, actually, I believe what she said was that there’ s a lot of policies that have led to this unrest.But, Anderson, when I ran
//for mayor of Baltimore in 1999...
//
//COOPER: She actually— just
//for the record, when she was asked which policies, to name two, she said zero tolerance.I mean, there’ s a number of old policies that we’ re seeing the results of.That distress of communities, where communities don’ t want to step forward and say who killed a 3 - year - old, it’ s a direct result of these failed policies.
//
//O’ MALLEY: Well,
//    let’ s talk about this a little bit.One of the things that was not reported during that heartbreaking night of unrest in Baltimore was that arrests had actually fallen to a 38 - year low in the year prior to the Freddie Gray’ s tragic death.Anderson, when I ran
//for mayor of Baltimore back in 1999, it was not because our city was doing well.It was because we allowed ourselves to become the most violent, addicted, and abandoned city in America.And I ran and promised people that together we could turn that around.And we put our city on a path to reduce violent crime, or part one(ph) crime by more than any other major city in America over the next 10 years.I did not make our city immune to setbacks.But I attended a lot of funerals, including one
//for a family of seven who were firebombed in their sleep
//for picking up the phone in a poor African - American neighborhood and calling the police because of drug dealers on their corner.We’ ve saved over a thousand lives in Baltimore in the last 15 years of people working together.And the vast majority of them were young and poor and black.It wasn’ t easy on any day.But we saved lives and we gave our city a better future, improving police and community relations every single day that I was in office.
//
...
//    ...supports background checks, and even the majority of gun owners do .Senator Sanders did vote five times against the Brady bill.Since it was passed, more than 2 million prohibited purchases have been prevented.He also did vote, as he said,
//        for this immunity provision.I voted against it.I was in the Senate at the same time.It wasn’ t that complicated to me.It was pretty straightforward to me that he was going to give immunity to the only industry in America.Everybody
//    else has to be accountable, but not the gun manufacturers.And we need to stand up and say: Enough of that.We’ re not going to
//    let it
//    continue.
//
//
...
//    try
//    to transform their grief, they went to court, where sometimes progress does happen when you file in court, but in this
//case, you want to talk about a— a rigged game, Senator ? The game was rigged.A man had sold 4, 000 rounds of military ammunition to this— this person that killed their daughter, riddled her body with five bullets, and he didn’ t even ask where it was going.And not only did their
//case get thrown out of court, they were slapped with $200, 000 in court fees because of the way that the NRA gets its way in our Congress and we take a backseat.It’ s time to stand up and pass comprehensive gun safety legislation as a nation.
//
//
//COOPER:
//    Senator Sanders, I want you to be able to respond, 30 seconds.
//
...
//    SANDERS: Governor...
//
//    O’ MALLEY: And we did it by leading with principle, not by pandering to the NRA and backing down to the NRA.SANDERS: Well, as somebody who has a D - minus voting record...(CROSSTALK)
//
...
//    (LAUGHTER)
//
//    SANDERS: And when you want to, check it out.And
//    if you think—
//    if you think that we can simply go forward and pass something tomorrow without bringing people together, you are sorely mistaken.
//
...
//        COOPER: Senator...
//
//    WEBB: May I ? People are going back and forth here
//    for 10 minutes here.There are people at high levels in this government who have bodyguards 24 hours a day, seven days a week.The average American does not have that, and deserves the right to be able to protect their family.
//
//    COOPER: Senator— Governor Chafee, you have an F rating from the NRA, what do you think about what Senator Webb just said ?
//
//            CHAFEE : Yes, I have a good record of voting
//        for
//        gun commonsense safety legislation, but the reality is, despite these tragedies that happen time and time again, when legislators step up to pass commonsense gun safety legislation, the gun lobby moves in and tells the people they’ re coming to take away your guns.And, they’ re successful at it, in Colorado and others states, the legislators that vote
//    for commonsense gun safety measures then get defeated.I even saw in Rhode Island.So, I would bring the gun lobby in and say we’ ve got to change this.Where can we find common ground ? Wayne Lapierre from the NRA, whoever it is, the leaders.Come one, we’ ve go to change this.We’ re not coming to take away your guns, we believe in the Second Amendment, but
...
//
//        BASH : Governor Chafee, you were the only Republican in the Senate to vote against the Iraq war.You say Secretary Clinton should be disqualified from the presidency because she voted in favor of using force in Iraq.She has since said that her vote was a mistake.Why isn’ t that good enough ? CHAFEE : Well, we just heard Senator Sanders say that it’ s the worst decision in American history.That’ s very significant, the worst decision in American history, I just heard from Senator Sanders.So, as we look ahead,
//        if you’ re going to make those poor judgment calls, a critical time in our history, we just finished with the Vietnam era, getting back into another quagmire—
...
//
//    CLINTON: Well, I recall very well being on a debate stage, I think, about 25 times with then Senator Obama, debating this very issue.After the election, he asked me to become Secretary of State.He valued my judgment, and I spent a lot of time with him...
//
//    ...in the Situation Room, going over some very difficult issues.You know, I— I agree completely.We don’ t want American troops on the ground in Syria.I never said that.What I said was we had to put together a coalition— in fact, something that I worked on before I left the State Department— to do,
//        and yes, that it should include Arabs, people in the region.Because what I worry about is what will happen with ISIS gaining more territory, having more reach, and, frankly, posing a threat to our friends and neighbors in the region and far beyond.So I think
//    while you’ re talking about the tough decision that President Obama had to make about Osama bin Laden, where I was one of his few advisers, or putting together that coalition to impose sanctions on Iran— I think I have a lot of evidence...
//
//    (CROSSTALK)
//
//    BASH: Senator Sanders— Senator Sanders, I want to bring you in here.My question
//    for you is, as a congressman, you voted against the Iraq War.You voted against the Gulf War.You’ re just talking about Syria, but under what circumstances would a President Sanders actually use force ?
//
...
//        let’ s stop ethnic cleansing in Kosovo, ”I voted
//    for that.I voted to make sure that Osama bin Laden was held accountable in Afghanistan.When our country is threatened, or when our allies are threatened, I believe that we need coalitions to come together to address the major crises of this country.I do not support the United States getting involved in unilateral action.
//
//        (UNKNOWN):
//        You’ re at work with our allies.
//
//    (CROSSTALK)
//
...
//    (CROSSTALK)
//
//    COOPER: Secretary Clinton voted to authorize military force in Iraq, supported more troops in Afghanistan.As Secretary of State, she wanted to arm Syrian rebels and push
//    for the bombing of Libya.Is she too quick to use military force ?
//
//        O’ MALLEY : Anderson, no president— no commander in chief— should take the military option off the table, even
//    if most of us would agree that it should be the last option.What disturbed people so much about— and I would agree with Senator Sanders on this— leading us into Iraq under false pretenses and telling us, as a people, that there were weapons of mass destruction there was— was one of the worst blunders in modern American history.But the reason why people remain angry about it is because people feel like a lot of our legislators got railroaded in a war fever and by polls.And I remember being at a dinner shortly before that invasion.People were talking at— and saying, “it’ ll take us just a couple years to rebuild democracy, ”and I thought, “has this world gone mad ? ”Whenever we go— and contrary to John Quincy Adams’ advice—“ searching the world
//    for monsters to destroy, ”and when we use political might to take a— at the expense of democratic principle, we hurt ourselves, and we hurt our(inaudible).
//
//    COOPER: Does she— does she want to use military force too rapidly ?
//
//        O’ MALLEY : I believe that, as president, I would not be so quick to pull
//    for a military tool.I believe that a no - fly zone in Syria, at this time, actually, Secretary, would be a mistake.You have to enforce no - fly zones, and I believe, especially with the Russian air force in the air, it could lead to an escalation because of an accident that we would deeply regret.I support President Obama.I think we have to play a long game, and I think, ultimately— you want to talk about blunders ? I think Assad’ s invasion of Syria will be seen as a blunder.
//
//    COOPER: Governor O’ Malley, just
//    for the record, on the campaign trail, you’ ve been saying that Secretary Clinton is always quick
//    for the—
//    for the military intervention.Senator— Secretary Clinton, you can respond.
//
...
//
//    WEBB: Thank you.I’ ve been standing over here
//    for about ten minutes, trying.
//
//    COOPER: OK.WEBB: It’ s just— it’ s gone back and forth over there.COOPER: Secretary ?
//
...
//            COOPER: Senator...
//
//        WEBB: And I would say this.I’ ve been waiting
//    for 10 minutes.I will say this.
//
//    COOPER: You’ re over your time as of now.
//
//    WEBB: I will— well, you’ ve
//    let a lot of people go over their time.I would say this...
//
...
//
//        CLINTON : Well,
//        let’ s remember what was going on.We had a murderous dictator, Gadhafi, who had American blood on his hands, as I’ m sure you remember, threatening to massacre large numbers of the Libyan people.We had our closest allies in Europe burning up the phone lines begging us to help them
//    try to prevent what they saw as a mass genocide, in their words.And we had the Arabs standing by our side saying, “We want you to help us deal with Gadhafi.”Our response, which I think was smart power at its best, is that the United States will not lead this.We will provide essential, unique capabilities that we have, but the Europeans and the Arabs had to be first over the line.We did not put one single American soldier on the ground in Libya.And I’ ll say this
//    for the Libyan people...
//
//    COOPER: But American citizens did lose their lives in Benghazi.
//
//    CLINTON: But
//    let— I’ ll get to that.But I think it’ s important, since I understand Senator Webb’ s very strong feelings about this, to explain where we were then and to point out that I think President Obama made the right decision at the time.And the Libyan people had a free election the first time since 1951. And you know what, they voted
//    for moderates, they voted with the hope of democracy.Because of the Arab Spring, because of a lot of other things, there was turmoil to be followed.But unless you believe the United States should not send diplomats to any place that is dangerous, which I do not, then when we send them forth, there is always the potential
//        for
//        danger and risk.
//
...
//    (CROSSTALK)
//
//    O’ MALLEY: Anderson, I think there’ s lessons to be learned from Benghazi.And those lessons are that we need to do a much better job as a nation of having human intelligence on the ground so that we know who the emerging next generation leaders are that are coming up to replace a dictator when his time on this planet ends.And I believe that’ s what Chris Stevens was trying to do .But he did not have the tools.We have failed as a country to invest in the human intelligence that would allow us to make not only better decisions in Libya, but better decisions in Syria today.And it’ s a huge national security failing.COOPER: Senator Webb, I want you to be able to respond.
//
//            WEBB: Thank you.
//
//        (CROSSTALK)
//
//        COOPER: Senator Webb ? WEBB : This is not about Benghazi per se.To me it is the inevitability of something like Benghazi occurring in the way that we intervened in Libya.We had no treaties at risk.We had no Americans at risk.There was no threat of attack or imminent attack.There is plenty of time
//    for a president to come to the Congress and request authority to use military force in that situation.I called
//    for it on the Senate floor again and again.I called
//    for it in Senate hearings.It is not a wise thing to do .And
//        if
//    people think it was a wise thing to do,
//    try to get to the Tripoli airport today.You can’ t do it.
//
//        COOPER: Secretary(sic) Webb, you served in Vietnam.You’ re a marine.Once a marine, always a marine.You served as a marine in Vietnam.You’ re a decorated war hero.You eventually became secretary of the navy.During the Vietnam War, the man standing next to you, Senator Sanders, applied
//    for status as a conscientious objector.Given his history, can he serve as a credible commander - in -chief ?
//
//        WEBB : Everybody makes their decisions when the time there is conscription.And as long as they go through the legal process that our country requires, I respect that.And it would be
//    for the voters to decide whether Senator Sanders or anyone
//    else should be president.I will say this, coming from the position that I’ ve come from, from a military family, with my brother a marine, my son was a marine in Iraq, I served as a marine, spending five years in the Pentagon, I am comfortable that I am the most qualified person standing up here today to be your commander - in -chief.
//
//    COOPER: Senator Sanders, tell an American soldier who is watching right now tonight in Afghanistan why you can be commander - in -chief given that you applied
//    for conscientious objector status.
//
//    SANDERS: Well, first of all,
//        let me applaud my good friend Jim Webb
//    for his service to this country in so many ways.
//
//
...
//    for each of you.Governor Chafee, what is the greatest national security threat to the United States ?
//
...
//    climate change, of course, makes cascading threats even more(inaudible).
//
...
//
//        SANDERS : The scientific community is telling us that
//    if we do not address the global crisis of climate change, transform our energy system away from fossil fuel to sustainable energy, the planet that we’ re going to be leaving our kids and our grandchildren may well not be habitable.That is a major crisis.
//
//    COOPER: Senator Webb ?
//
...
//
//    COOPER: All right.We’ re going to take a short
//    break.Do these candidates see eye to eye on an issue that is driving a big wedge between Republicans ? That is next.We’ ll be right back.
//        (COMMERCIAL BREAK)
//
//    COOPER: And welcome back.We are live in Nevada, in Las Vegas, at the Wynn Resort
//    for the first Democratic presidential debate.The questions
//    continue.We begin with Secretary Clinton.Secretary Clinton, you are going to be testifying before Congress next week about your e - mails.For the last eight months, you haven’ t been able to put this issue behind you.You dismissed it;
//    you joked about it;
//    you called it a mistake.What does that say about your ability to handle far more challenging crises as president ?
//
//        CLINTON : Well, I’ ve taken responsibility
//    for it.I did say it was a mistake.What I did was allowed by the State Department, but it wasn’ t the best choice.And I have been as transparent as I know to be, turning over 55, 000 pages of my e - mails, asking that they be made public.And you’ re right.I am going to be testifying.I’ ve been asking to testify
//    for some time and to do it in public, which was not originally agreed to.But
...
//            COOPER : Secretary...
//
//        CLINTON: How are we going to get health care
//    for
//    everybody...
//
//    (CROSSTALK)
...
//
//    SANDERS: You know ? The middle class— Anderson, and
...
//
//
//    I know that plays well in this room.But I got to be honest, Governor Chafee,
//        for the record, on the campaign trail, you’ ve said a different thing.You said this is a huge issue.Standing here in front of Secretary Clinton, are you willing to say that to her face ?
//
...
//
//
//    Governor, it’ s popular in the room, but a lot of people do want to know these answers.Governor O’ Malley, you expressed concern on the campaign trail that the Democratic Party is, and I quote, “being defined by Hillary Clinton’ s email scandal.”You heard her answer, do you still feel that way tonight ?
//
//                O’ MALLEY : I believe that now that we’ re
//            finally
//            having debates, Anderson, that we don’ t have to be defined by the email scandal, and how long— what the FBI’ s asking about.Instead, we can talk about affordable college, making college debt free, and all the issues.Which is why— and I see the chair of the DNC here, look how glad we are actually to be talking about the issues that matter the most to people around the kitchen table.We need to get wages to go up, college more affordable...
//
//        COOPER: ...Thank you, governor.
//
//    O’ MALLEY: ...we need to make American 100 percent clean electric by 2050.
//
//    COOPER: I want to talk about issues of race in America,
//        for that I want to start of with Don Lemon.
//
...
//
//    WILKINS: ...law school.My question
//    for the candidates is, do black lives matter, or do all lives matter ?
//
...
//
//                O’ MALLEY : Anderson, the point that the Black Lives Matter movement is making is a very, very legitimate and serious point, and that is that as a nation we have undervalued the lives of black lives, people of color.When I ran
//            for
//            Mayor of Baltimore— and we we burying over 350 young men ever single year, mostly young, and poor, and black, and I said to our legislature, at the time when I appeared in front of them as a mayor, that
//        if
//    we were burying white, young, poor men in these number we would be marching in the streets and there would be a different reaction.Black lives matter, and we have a lot of work to do to reform our criminal justice system, and to address race relations in our country.
//
//
//        COOPER: Secretary Clinton, what would you do
//            for African Americans in this country that President Obama couldn’ t ?
//
...
//
//
//    CLINTON: ...We need a new New Deal
//    for communities of color...
//
//    COOPER: Senator Webb ?
//
//        WEBB : I hope I can get that kind of time here.As a President of the United States, every life in this country matters.At the same time, I believe I can say to you, I have had a long history of working with the situation of African Americans.We’ re talking about criminal justice reform, I risked my political life raising the issue of criminal justice reform when I ran
//    for the Senate in Virginia in 2006. I had democratic party political consultants telling me I was committing political suicide.We led that issue in the congress.We started a national debate on it.And it wasn’ t until then that the Republican Party started joining in .I also represented a so - called war criminal, an African American Marine who was wounded— who was convicted of murder in Vietnam,
//        for six years.He took his life three years into this.I cleared his name after— after three years.
//
//    COOPER: Thanks, sir.
//
//    WEBB: And I put the African American soldier on the Mall.I made that recommendation and fought
//    for it.So,
//        if you want someone who is— can stand up in front of you right now and say I have done the hard job, I have taken the risks, I am your person.
//
//    COOPER: Senator Sanders,
//        let’ s talk about income inequality.Wages and incomes are flat.You’ ve argued that the gap between rich and poor is wider than at any time since the 1920 s.We’ ve had a Democratic president
//    for seven years.What are you going to be able to do that President Obama didn’ t ?
//
//            SANDERS : Well, first of all,
//            let’ s remember where we were when Bush left office.We were losing 800, 000 jobs a month.And I know my Republican friends seem to have some amnesia on this issue, but the world’ s financial crisis was on— the world’ s financial markets system was on the verge of collapse.That’ s where we were.Are we better off today than we were then ? Absolutely.But the truth is that
//        for
//        the 40 years, the great middle class of this country has been disappearing.And in my view what we need to do is create millions of jobs by rebuilding our crumbling infrastructure;
//        raise the minimum wage to $15 an hour;
//    pay equity
//    for women workers;
//    and our disastrous trade policies, which have cost us millions of jobs;
//    and make every public college and university in this country tuition free.
//
//
//    COOPER: Secretary Clinton...(CROSSTALK)
//
//    COOPER: I’ ll
//    let you jump in a moment.Everybody will get in on this in a moment.Secretary Clinton, how would you address this issue ? In all candor, you and your husband are part of the one percent.How can you credibly represent the views of the middle class ?
//
//        CLINTON : Well, you know, both Bill and I have been very blessed.Neither of us came from wealthy families and we’ ve worked really hard our entire lives.And I want to make sure every single person in this country has the same opportunities that he and I have had, to make the most of their God - given potential and to have the chances that they should have in America
//    for a good education, good job training, and then good jobs.I have a five point economic plan, because this inequality challenge we face, we have faced it at other points.It’ s absolutely right.It hasn’ t been this bad since the 1920 s.But
//    if you look at the Republicans versus the Democrats when it comes to economic policy, there is no comparison.The economy does better when you have a Democrat in the White House and that’ s why we need to have a Democrat in the White House in January 2017.
//
//    COOPER: Governor O’ Malley, (inaudible).
//
//    O’ MALLEY: Yes.Anderson, I want to associate myself with many of the items that the senator from Vermont mentioned, and I actually did them in our state.We raised the minimum wage, passed the living wage, invested more in infrastructure, went four years in a row without a penny’ s increase in college tuition.But there’ s another piece that Senator Sanders left out tonight, but he’ s been excellent about underscoring that.And that is that we need to separate the casino, speculative, mega - bank gambling that we have to insure with our money, from the commercial banking— namely, reinstating Glass - Steagall.Secretary Clinton mentioned my support eight years ago.And Secretary, I was proud to support you eight years ago, but something happened in between, and that is, Anderson, a Wall Street crash that wiped out millions of jobs and millions of savings
//    for families.And we are still just as vulnerable Paul Volcker says today.We need to reinstate Glass - Steagall and that’ s a huge difference on this stage among us as candidates.
//
//    COOPER: Just
//    for viewers at home who may not be reading up on this, Glass - Steagall is the Depression - era banking law repealed in 1999 that prevented commercial banks from engaging in investment banking and insurance activities.Secretary Clinton, he raises a fundamental difference on this stage.Senator Sanders wants to
//    break up the big Wall Street banks.You don’ t.You say charge the banks more,
//        continue to monitor them.Why is your plan better ?
//
//        CLINTON : Well, my plan is more comprehensive.And frankly, it’ s tougher because of course we have to deal with the problem that the banks are still too big to fail.We can never
//    let the American taxpayer and middle class families ever have to bail out the kind of speculative behavior that we saw.But we also have to worry about some of the other players— AIG, a big insurance company;
//    Lehman Brothers, an investment bank.There’ s this whole area called“ shadow banking.”That’ s where the experts tell me the next potential problem could come from.
//
//    CLINTON: So I’ m with both Senator Sanders and Governor O’ Malley in putting a lot of attention onto the banks.And the plan that I have put forward would actually empower regulators to
//    break up big banks
//    if we thought they posed a risk.But I want to make sure we’ re going to cover everybody, not what caused the problem last time, but what could cause it next time.
//
//    (CROSSTALK)
//
...
//
//    CLINTON: But I’ m telling you— I will say it tonight.If only you look at the big banks, you may be missing the forest
//    for the trees.
//
//    (CROSSTALK)
//
...
//    (LAUGHTER)
//
//    SANDERS: I’ ll tell him.In my view, Secretary Clinton, you do not— Congress does not regulate Wall Street.Wall Street regulates Congress.And we have gotta
//        break
//        off these banks.Going to them...
//
//    CLINTON: So...
//
//    SANDERS: ...and saying, “please, do the right thing”...
//
//        CLINTON: ...no, that’ s not what...SANDERS: ...is kind of naive.
//
//    CLINTON: ...that— I think Dodd - Frank was a very...WEBB: Anderson, I need to jump in (inaudible).
//
//    CLINTON: ...good start, and I think that we have to implement it.We have to prevent the Republicans from ripping it apart.We have to save the Consumer Financial Protection board, which is
//    finally beginning to act to protect consumers.We have work to do .You’ ve got no argument from me.But I know,
//        if we don’ t come in with a very tough and comprehensive approach, like the plan I’ m recommending, we’ re gonna be behind instead of ahead...
//
//    COOPER: Governor O’ Malley ? Where do you stand ?
//
//            CLINTON : ...on what the next crisis could be.
//
//        O’ MALLEY : Anderson, look, this is— the big banks— I mean, once we repealed Glass - Steagall back in the late 1999 s(ph), the big banks, the six of them, went from controlling, what, the equivalent of 15 percent of our GDP to now 65 percent of our GDP.And—(inaudible) right before this debate, Secretary Clinton’ s campaign put out a lot of reversals on positions on Keystone and many other things.But one of them that we still have a great difference on, Madam Secretary, is that you are not
//    for Glass - Steagall.You are not
//    for putting a firewall between this speculative, risky shadow banking behavior.I am, and the people of our country need a president who’ s on their side, willing to protect the Main Street economy from recklessness on Wall Street.We have to fulfill...
//
//    COOPER: Secretary Clinton...
//
...
//    if you are learning, you’ re gonna change your position.I never took a position on Keystone until I took a position on Keystone.But I have been on the forefront of dealing with climate change, starting in 2009, when President Obama and I crashed(ph) a meeting with the Chinese and got them to sign up to the first international agreement to combat climate change that they’ d ever joined.So I’ m...
//
//    COOPER: Thank you.
//
...
//
//
//    Senator Sanders, in 2008, congressional leaders were told, without the 2008 bailout, the U.S.was possibly days away from a complete meltdown.Despite that, you still voted against it.As president, would you stand by your principles
//    if it risked the country’ s financial stability ?
//
//        SANDERS : Well, I remember that meeting very well.I remember it like it was yesterday.Hank Paulson, Bernanke came in , and they say, “guys, the economy is going to collapse because Wall Street is going under.It’ s gonna take the economy with them.”And you know what I said to Hank Paulson ? I said, “Hank, your guys— you come from Goldman Sachs.Your millionaire and billionaire friends caused this problem.How about your millionaire and billionaire friends paying
//    for the bailout, not working families in this country ? ”So to answer your question, no, I would not have
//    let the economy collapse.But it was wrong to ask the middle class to bail out Wall Street.And by the way, I want Wall Street now to help kids in this country go to college, public colleges and universities, free with a Wall Street speculation tax.
//
//
...
//
//        WEBB : There is a reality that I think we all need to recognize with respect to the power of the financial sector.And
//    let me just go back a minute and say that on this TARP program, I introduced a piece of legislation calling
//    for a windfall profits tax on the executives of any of these companies that got more than $5 billion, that it was time
...
//
//    COOPER: You agreed to these rules and you’ re wasting time.So
//    if you would finish your answer, we’ ll move on.
//
//    WEBB: All right.Well, I’ m trying to set a mark here so maybe we can get into a little more later on.This hasn’ t been equal time.But
//    if you want to look at what has happened,
...
//
//    COOPER: Governor Chafee, you have attacked Secretary Clinton
//    for being too close to Wall Street banks.In 1999 you voted
//    for the very bill that made banks bigger.
//
//    Continue reading the main story
//    INTERACTIVE GRAPHIC
...
//
//    COOPER: Are you saying you didn’ t know what you were voting
//    for ?
//
...
//
//        CHAFEE : I think you’ re being a little rough.I’ d just arrived at the United States Senate.I’ d been mayor of my city.My dad had died.I’ d been appointed by the governor.It was the first vote and it was 90 - 5, because it was a conference report.But
//    let me just say about income inequality.We’ ve had a lot of talk over the last few minutes, hours, or tens of minutes, but no one is saying how we’ re going to fix it.And it all started with the Bush tax cuts that favored the wealthy.So
//    let’ s go back to the tax code.And 0.6 percent of Americans are at the top echelon, over 464, 000, 0.6 Americans.That’ s less than 1 percent.But they generate 30 percent of the revenue.And they’ re doing fine.
//
//    COOPER: Thank you, Governor.
//
//    CHAFEE: So there’ s still a lot more money to be had from this top echelon.I’ m saying
//    let’ s have another tier and put that back into the tax bracket.And that will generate $42 billion.
//
...
//    COOPER: Dana ?
//
//        BASH : Thank you.CNN visited college campuses, along with Facebook.And not surprisingly college affordability was among the most pressing issue.Senator Sanders, you’ ve mentioned a couple of times you do have a plan to make public colleges free
//        for
//        everyone.Secretary Clinton has criticized that in saying she’ s not in favor of making a college free
//    for Donald Trump’ s kids.Do you think taxpayers should pick up the tab
...
//    for everybody going to college.I think we don’ t need a complicated system, which the secretary is talking about, the income goes down, the income goes down,
//        if you’ re poor you have to work, and so forth and so on.I pay
//    for my program, by the way, through a tax on Wall Street speculation, which will not only make public colleges and universities tuition - free, it will substantially lower interest rates on college debt, a major crisis in this country.
//
//
...
//
//        CLINTON : Well,
//        let me address college affordability, because I have a plan that I think will really zero in on what the problems are.First, all the 40 million Americans who currently have student debt will be able to refinance their debt to a low interest rate.That will save thousands of dollars
//    for people who are now struggling under this cumbersome, burdensome college debt.As a young student in Nevada said to me, the hardest thing about going to college should not be paying
//    for it.So then we have to make it more affordable.How do we make it more affordable ? My plan would enable anyone to go to a public college or university tuition free.You would not have to borrow money
//        for
//        tuition.But I do believe— and maybe it’ s because I worked when I went through college;
//        I worked when I went through law school— I think it’ s important
//    for everybody to have some part of getting this accomplished.That’ s why I call it a compact.
//
...
//
//    SANDERS: ...in order to make it possible
//    for them to afford their education.And I want colleges to get their costs down.They are outrageously high in what they’ re charging.
//
//    BASH: Secretary Clinton, the question was not just about tuition, though.It was about Senator Sanders’ plan to expand Social Security, to make Medicare available to all Americans.Is that something that you would support ? And
//    if not, why not ?
//
...
//    for the poorest recipients of Social Security.We have a lot of women on Social Security, particularly widowed and single women who didn’ t make a lot of money during their careers, and they are impoverished, and they need more help from the Social Security system.And I will focus— I will focus on helping those people who need it the most.And of course I’ m going to defend Social Security.I’ m going to look
//    for ways to
//    try to make sure it’ s solvent into the future.And we also need to talk about health care at some time, because we agree on the goals, we just disagree on the means.
//
//    SANDERS: When the Republicans— when the Republicans in the Congress and some Democrats were talking about cutting Social Security and benefits
//    for disabled veterans,
//    for the so - called chained CPI, I founded a caucus called the Defending Social Security Caucus.My view is that when you have millions of seniors in this country trying to get by— and I don’ t know how they do on $11, 000, $12, 000, $13, 000 a year— you don’ t cut Social Security, you expand it.And the way you expand it is by lifting the cap on taxable incomes so that you do away with the absurdity of a millionaire paying the same amount into the system as somebody making $118, 000. You do that, Social Security is solvent until 2061 and you can expand benefits.
//
//                (CROSSTALK)
//
...
//
//                LOPEZ : Gracias, Anderson.Senator Sanders, in 2013, you voted
//            for
//            immigration reform.But in 2007, when Democrats controlled Congress and the Bush White House was onboard, you voted against it.Why should Latino voters trust you now when you left them at the altar at the moment when reform was very close ?
//
//            SANDERS : I didn’ t leave anybody at the altar.I voted against that piece of legislation because it had guest - worker provisions in it which the Southern Poverty Law Center talked about being semi - slavery.Guest workers are coming in , they’ re working under terrible conditions, but
//        if
//    they stand up
//    for their rights, they’ re thrown out of the country.I was not the only progressive to vote against that legislation
//    for that reason.Tom Harkin, a very good friend of Hillary Clinton’ s and mine, one of the leading labor advocates, also voted against that.
//
//    LOPEZ: Tom Harkin isn’ t running
//    for president.You are.
//
//    SANDERS: I know that.But point being is that progressives did vote against that
//    for that reason.My view right now— and always has been— is that when you have 11 million undocumented people in this country, we need comprehensive immigration reform, we need a path toward citizenship, we need to take people out of the shadows.
//
...
//
//        CLINTON : Well, first of all, I want to make sure every child gets health care.That’ s why I helped to create the Children’ s Health Insurance Program, and I want to support states that are expanding health care and including undocumented children and others.I want to open up the opportunity
//    for immigrants to be able to buy in to the exchanges under the Affordable Care Act.I think to go beyond that, as I understand what Governor O’ Malley has recommended, so that they would get the same subsidies.I think that is— it raises so many issues.It would be very difficult to administer, it needs to be part of a comprehensive immigration reform, when we
//    finally do get to it.
//
//    LOPEZ: Governor O’ Malley ?
//
//        O’ MALLEY : Juan Carlos, I think what you’ ve heard up here is some of the old thinking on immigration reform, and that’ s why it’ s gridlocked.We need to understand that our country is stronger in every generation by the arrival of new American immigrants.That is why I have put out a policy
//    for comprehensive immigration reform, that is why I would go further than President Obama has on DACA, and DAPA.I mean, we are a nation of immigrants, we are made stronger by immigrants.Do you think
//    for a second that simply because somebody’ s standing in a broken que on naturalization they’ re not going to go to the hospital, and that care isn’ t going to fall on to our insurance rates ? I am
//    for a generous, compassionate America that says we’ re all in this together.We need comprehensive
//
//    COOPER: Senator Webb...
//
//    O’ MALLEY: ...immigration reform.It’ ll make wages go up in America $250
//    for every year...
//
...
//    COOPER: ...Thank you, Senator.
//
//    WEBB: ...lost(ph)— I introduced that in 2007— We need a comprehensive reform, and we need to be able to define our borders.COOPER: Secretary Clinton ?
//
...
//
//    COOPER: Secretary Clinton,
//        let me ask you.Two of your rivals from your left, Governor O’ Malley, and Senator Sanders, want to provide instate college tuition to undocumented immigrants.Where do you stand on that ?
//
...
//
//            CLINTON: If their states agree, then we want more states to do the same thing.COOPER: Governor O’ Malley ? O’ MALLEY : Anderson, we actually did this in my state of Maryland.We passed...
//
//
...
//    (CHEERING)
//
//    O’ MALLEY: Tried to mischaracterize it as free tuition
//    for illegal immigrants.But, we took our
//case to the people when it was petitioned to referendum, and we won with 58 percent of the vote.The more our children learn, the more they will earn, and that’ s true of children who have yet to be naturalized...
//
//COOPER:
//    ...Senator...
//
...
//
//    COOPER: Senator Sanders, you talked about your record on the Veteran affairs committee.You served on that committee
//    for the last eight years, including two years as its chairman
//    while veterans died waiting
//    for health care.You and Senator McCain ultimately addressed the issue with bi - partisan legislation.Why did it take 18 Inspector General reports, and a CNN investigation, and others, before you and your colleagues took action ?
//
//        SANDERS : Well, I was chairman
//    for two years, and when I was chairman we did take action.What we did is pass a $15 billion dollar piece of legislation which brought in many, many new doctors, and nurses into the V.A.so that veterans in this country could get the health care when they needed it, and not be on long waiting lines.And, the other part of that legislation said that
//    if a veteran is living more than 40 miles away from a V.A.facility, that veteran could get health care from the community health center, or the private sector.As a result of that legislation, we went further in than any time in recent history in improving health care
//    for the men and women of this country who put their lives on the line to defend them.
//
//    COOPER: Governor Chafee, you and Hillary Clinton both voted
//    for the Patriot Act which created the NSA surveillance program.You’ ve emphasized civil liberties, privacy during your campaign.Aren’ t these two things in conflict ?
//
//        CHAFEE : No, that was another 99 to one vote
//    for the Patriot Act, and it was seen as at the time modernizing our ability to do what we’ ve always done to tap phones which always required a warrant.And I voted
//    for
//    that.
//
...
//
//    COOPER: ...and the reauthorization votes.Let me ask you,
//        if elected, would you shut down the NSA surveillance program ?
//
//        SANDERS : I’ m sorry ?
//
//        COOPER : Would you shut down the NSA surveillance program ?
//
//        SANDERS : Absolutely.Of course.COOPER: You would, point blank.
//
//    SANDERS: Well, I would shut down— make— I’ d shut down what exists right now is that virtually every telephone call in this country ends up in a file at the NSA.That is unacceptable to me.But it’ s not just government surveillance.I think the government is involved in our e - mails;
//    is involved in our websites.Corporate America is doing it as well.If we are a free country, we have the right to be free.Yes, we have to defend ourselves against terrorism, but there are ways to do that without impinging on our constitutional rights and our privacy rights.
//
...
//
//        CHAFEE : ...the American government was acting illegally.That’ s what the federal courts have said;
//    what Snowden did showed that the American government was acting illegally
//    for the Fourth Amendment.So I would bring him home.
//
...
//
//    COOPER: Should he do jail time ? ClINTON : In addition— in addition, he stole very important information that has unfortunately fallen into a lot of the wrong hands.So I don’ t think he should be brought home without facing the music.
//
//        COOPER: Governor O’ Malley, Snowden ?
//
//
//        O’ MALLEY : Anderson, Snowden put a lot of Americans’ lives at risk.Snowden broke the law.Whistleblowers do not run to Russia and
//        try
//        to get protection from Putin.If he really believes that, he should be back here.
//
//    COOPER: Senator Sanders, Edward Snowden ?
//
//        SANDERS : I think Snowden played a very important role in educating the American people to the degree in which our civil liberties and our constitutional rights are being undermined.COOPER: Is he a hero ?
//
//        SANDERS : He did— he did
//    break the law, and I think there should be a penalty to that.But I think what he did in educating us should be taken into consideration before he is(inaudible)
//
//    .COOPER: Senator Webb, Edward Snowden ?
//
//        WEBB : I— well, I— I would leave his ultimate judgment to the legal system.Here’ s what I do believe.We have a serious problem in terms of the collection of personal information in this country.And one of the things that I did during the FISA bill in 2007, the Foreign Intelligence Surveillance Act, was introduce with Russ Feingold two amendments basically saying, “We understand the realities of how you have to collect this broad information in the Internet age, but after a certain period of time, you need to destroy the personal information that you have
//        if
//    people have not been brought—
//    if criminal justice proceedings have not been brought against them.”We’ ve got a vast data bank of information that is ripe
//    for people with bad intentions to be able to use.And they need to be destroyed.
//
//    COOPER: Another— another question
//    for each of you, starting with Governor Chafee.Name the one thing— the one way that your administration would not be a third term of President Obama.
//
...
//        COOPER: Senator Sanders ?
//
//        SANDERS : I have a lot of respect
//    for president Obama.I have worked with him time and time again on many, many issues.But here’ s where I do disagree.I believe that the power of corporate America, the power of Wall Street, the power of the drug companies, the power of the corporate media is so great that the only way we really transform America and do the things that the middle class and working class desperately need is through a political revolution when millions of people begin to come together and stand up and say: Our government is going to work
//            for
//            all of us, not just a handful of billionaires.
//
//
//        COOPER: Senator Webb, how would you not be a third term
//    for Obama ?
//
//        Continue reading the main story
//    First Draft Newsletter
//    Subscribe
//    for updates on the 2016 presidential race, the White House and Congress, delivered to your inbox Monday - Friday.
//
//
//    WEBB: I got a great deal of admiration and affection
//    for Senator Sanders, but I— Bernie, I don’ t think the revolution’ s going to come.And I don’ t think the Congress is going to pay
//    for a lot of this stuff.And
//    if there would be a major difference between my administration and the Obama administration, it would be in the use of executive authority.I came up as a committee counsel in the Congress, used to put dozens of bills through the House floor every year as a committee counsel on the Veterans Committee.I have a very strong feeling about how our federal system works and how we need to lead and energize the congressional process instead of allowing these divisions to
//    continue to paralyze what we’ re doing.So I would lead— working with both parties in the Congress and working through them in the traditional way that our Constitution sets(ph).
//
...
//    (LAUGHTER)
//
//    COOPER: It’ s a long story.Let’ s
//    continue, shall we ? Secretary Clinton, welcome back.
//
...
//
//    COOPER: (inaudible).Senator Sanders, does she have the right stuff ?
//
//        SANDERS : I think— I think that there is profound frustration all over this country with establishment politics.I am the only candidate running
//    for president who is not a billionaire, who has raised substantial sums of money, and I do not have a super PAC.
//
...
//
//        LEMON : All right.This one is
//    for Martin O’ Malley.Anderson, Governor O’ Malley, this is from Anna Bettis from Tempe, Arizona.Here it is.
//
//    (BEGIN VIDEO CLIP)
//
...
//
//    O’ MALLEY: Yeah.Anna, I have put forward a plan— and I’ m the only candidate, I believe, in either party to do this— to move America forward to a 100 percent clean electric grid by 2050. We did not land a man on the moon with an all - of - the - above strategy.It was an intentional engineering challenge, and we solved it as a nation.And our nation must solve this one.So I put forward the plan that would extend the investor tax credits
//        for
//        solar and
//    for wind.If you go across Iowa, you see that 30 percent of their energy now comes from wind.We’ re here in Las Vegas, one of the most sustainable cities in America, doing important things in terms of green building, architecture and design.We can get there as a nation, but it’ s going to require presidential leadership.And as president, I intend to sign as my very first order in office the— an order that moves us as a nation and dedicates our resources to solving this problem and moving us to a 100 percent clean electric grid by 2050.
//
//    COOPER: Governor...
//
...
//
//    CLINTON: Well, that— that’ s exactly what I’ ve been doing.When we met in Copenhagen in 2009 and, literally, President Obama and I were hunting
//    for the Chinese, going throughout this huge convention center, because we knew we had to get them to agree to something.Because there will be no effective efforts against climate change unless China and India join with the rest of the world.They told us they’ d left
//    for the airport;
//    we found out they were having a secret meeting.We marched up, we broke in , we said, “We’ ve been looking all over
//    for you.Let’ s sit down and talk about what we need to do .”And we did come up with the first international agreement that China has signed.Thanks to President Obama’ s leadership, it’ s now gone much further.
//
...
//    CLINTON: Mm - hmm.
//
//    BASH: Carly Fiorina, the first female CEO of a Fortune 50 company, argues,
//        if the government requires paid leave, it will force small businesses to, quote, “hire fewer people and create fewer jobs.”What do you say not only to Carly Fiorina, but also a small - business owner out there who says, you know, I like this idea, but I just can’ t afford it ?
//
//            CLINTON : Well, I’ m surprised she says that, because California has had a paid leave program
//        for
//        a number of years.And it’ s...
//
//    BASH: It’ s on the federal level.
//
//    CLINTON: Well, but all— well, on a state level, a state as big as many countries in the world.And it has not had the ill effects that the Republicans are always saying it will have.And I think this is— this is typical Republican scare tactics.We can design a system and pay
//    for it that does not put the burden on small businesses.I remember as a young mother, you know, having a baby wake up who was sick and I’ m supposed to be in court, because I was practicing law.I know what it’ s like.And I think we need to recognize the incredible challenges that so many parents face, particularly working moms.I see my good friend, Senator Gillibrand, in the front row.She’ s been a champion of this.We need to get a consensus through this campaign, which is why I’ m talking about it everywhere I go, and we need to join the rest of the advanced world in having it.
//
//    BASH: But Secretary— Secretary Clinton, even many people who agree with you might say, look, this is very hard to do,
//        especially in today’ s day and age.There are so many people who say, “Really ? Another government program ? Is that what you’ re proposing ? And at the expense of taxpayer money ? ”
//
//        CLINTON : Well, look, you know, when people say that— it’ s always the Republicans or their sympathizers who say, “You can’ t have paid leave, you can’ t provide health care.”They don’ t mind having big government to interfere with a woman’ s right to choose and to
//    try to take down Planned Parenthood.They’ re fine with big government when it comes to that.I’ m sick of it.You know, we can do these things.
//
//
//        We should not be paralyzed— we should not be paralyzed by the Republicans and their constant refrain, “big government this, big government that, ”that except
//    for what they want to impose on the American people.I know we can afford it, because we’ re going to make the wealthy pay
...
//        COOPER: Governor O’ Malley ?
//
//        O’ MALLEY : Anderson, in our state, we actually expanded family leave.And I have to agree with Secretary Clinton and Senator Sanders.Look, the genius of our nation is that we find ways in every generation to include more of our people more fully in the economic life of our country, and we need to do that
//        for
//        our families, and especially so that women aren’ t penalized in having to drop out of the workforce.My wife, Katie, is here with our four kids.And, man, that was a juggle when we had little kids and— and keeping jobs and moving forwards.We would be a stronger nation economically
//    if we had paid family leave.
//
...
//
//    LOPEZ: Thank you, Anderson.Senator Sanders, right here in Nevada, there will be a measure to legalize recreational marijuana on the 2016 ballot.
//
//    You’ ve said you smoked marijuana twice;
//    it didn’ t quite work
//    for you.If you were a Nevada resident, how would you vote ?
//
//        SANDERS : I suspect I would vote yes.
//
//
//    And I would vote yes because I am seeing in this country too many lives being destroyed
//    for non - violent offenses.We have a criminal justice system that lets CEOs on Wall Street walk away, and yet we are imprisoning or giving jail sentences to young people who are smoking marijuana.I think we have to think through this war on drugs...
//
//
//    SANDERS: ...which has done an enormous amount of damage.We need to rethink our criminal justice system, we we’ ve got a lot of work to do inthat area.
//
...
//    (LAUGHTER)
//
//    LOPEZ: When asked about legalizing recreational marijuana, you told her
//    let’ s wait and see how it plays out in Colorado and Washington.It’ s been more than a year since you’ ve said that.Are you ready to take a position tonight ?
//
//        CLINTON : No.I think that we have the opportunity through the states that are pursuing recreational marijuana to find out a lot more than we know today.I do support the use of medical marijuana, and I think even there we need to do a lot more research so that we know exactly how we’ re going to help people
//            for
//            whom medical marijuana provides relief.So, I think we’ re just at the beginning, but I agree completely with the idea that we have got to stop imprisoning people who use marijuana.Therefore, we need more states, cities, and the federal government to begin to address this so that we don’ t have this terrible result that Senator Sanders was talking about where we have a huge population in our prisons
//        for
//        nonviolent, low - level offenses that are primarily due to marijuana.
//
//    COOPER: Secretary Clinton, thank you.I want to go to Don Lemon with another Facebook question.
//
//    LEMON: Alright, Anderson.This is
//    for Senator Sanders, OK ? This is from Carrie(ph) Kang(ph) from Manassas, Virginia, would like would like to ask the Senator, “President Obama has had a difficult time getting Republicans to compromise on just about every agenda.How will you approach this going forward, and will it be any different ? ”Senator ?
//
//        SANDERS : The Republican party, since I’ ve been in the Senate, and since President Obama has been in office, has played a terrible, terrible role of being total obstructionists.Every effort that he has made, that some of us have made, they have said no, no, no.Now, in my view, the only way we can take on the right wing republicans who are, by the way, I hope will not
//    continue to control the Senate and the House when one of us elected President...
//
//
...
//
//
//    COOPER: We’ re going to hear from all the candidates coming up.We’ re going to take a short
//    break.More from the candidates in a moment.
//        (COMMERCIAL BREAK)
//
//    COOPER: And welcome back to the final round of the CNN Democratic presidential debate.This is a question to each of you.Each of you, by the way, are going to have closing statements to make.Each of you will have 90 seconds.But a final question to each of you.If you can, just
//    try to— 15 seconds
//    if you can.Governor Chafee, Franklin Delano Roosevelt once said, “I ask you to judge me by the enemies I have made.”You’ ve all made a few people upset over your political careers.Which enemy are you most proud of ?
//
//        (LAUGHTER)
//
//    CHAFEE: I guess the coal lobby.I’ ve worked hard
//    for climate change and I want to work with the coal lobby.But in my time in the Senate, tried to bring them to the table so that we could address carbon dioxide.I’ m proud to be at odds with the coal lobby.
//
//    COOPER: Governor O’ Malley ?
//
...
//    COOPER: Secretary Clinton ?
//
//        CLINTON : Well, in addition to the NRA, the health insurance companies, the drug companies, the Iranians.(LAUGHTER) Probably the Republicans.
//
//    (LAUGHTER)
//
//    COOPER: Senator Sanders ?
...
//
//    COOPER: All right.Time
//    for closing statements.Each of you will have 90 seconds.Governor Chafee,
//        let’ s begin with you.
//
//    CHAFEE: Thank you, Anderson.Thank you, CNN.And thank you, Facebook,
//        for sponsoring this debate.America has many challenges confronting us— ending the perpetual wars, addressing climate change, addressing income inequality, funding education, funding infrastructure, funding healthcare, helping black Americans, helping Native Americans.We have many challenges.Who is best able to confront these challenges ? I’ ve served in government at many levels.I know what it’ s like to solve problems at the local level because I did it as mayor.I know how to get legislation passed through Congress because I did it as a senator.I know how to turn around a state because I did as governor of Rhode Island.But what I’ m most proud of is that in 30 years of public service, I have had no scandals.I have high ethical standards.And what I’ m most proud of is my judgment, particularly in the Iraq war vote.There was a lot of pressure— political pressure, public pressure.But I did my homework and I did not believe that the evidence was there that Saddam Hussein had weapons of mass destruction.And we live now with the consequences.
//
//    CHAFEE: So that kind of judgment is what we want in a president going forward.And I’ m running
//    for president to end the wars.I want to be the peacemaker.I am a proven peacemaker.Please go to Chafee 2016 to learn more about me.Thank you.
//
//    COOPER: Governor Chafee, thank you very much.Senator Webb, your final statement
//    for 90 seconds.
//
//    WEBB: Thank you.Ladies and gentlemen, it’ s been a pleasure to be with you tonight.You’ ve heard a lot of promises up here;
//    you’ ve heard a lot of rhetoric.They all seem to happen during campaigns, and then once the election’ s over, people start from scratch again and
//    try to get things done.One of the things I can promise you,
//        if you look at my record, in and out of government, is that I’ ve always been willing to take on a complicated, something unpopular issues, and work them through, the complex issues, and work them through in order to have the solution.We did it with criminal justice reform.We’ ve had a lot of discussion here about criminal justice reform.We did it in other ways.We need a national political strategy
//    for our economy,
//    for our social policy,
//    for social justice, and, by the way,
//    for how you run and manage the most complex bureaucracy in the world, which is the federal government.I know how to lead.I did it in Vietnam, I did it in the Pentagon, I did it in the Senate, and
//    if you will help me overcome this cavalcade of— of financial irregularities and money that is poisoning our political process, I am ready to do that
//    for
...
//
//
//        COOPER: Well, that does it
//    for this Democratic presidential debate.On behalf of everyone at CNN, we want to thank the candidates, our debate partners at Facebook, the Wynn Resort, and the Democratic National Committee.Thanks also to Dana Bash, Juan Carlos Lopez, and Don Lemon.We’ ll be back in Las Vegas December 15 th, when CNN hosts our next Republican presidential debate.That will be moderated by my colleague, Wolf Blitzer.END `